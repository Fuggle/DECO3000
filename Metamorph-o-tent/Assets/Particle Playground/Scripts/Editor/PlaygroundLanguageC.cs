...
namespace ParticlePlaygroundLanguage {
	...
	public class PlaygroundLanguageC : ScriptableObject {
		...
		public string userPresetPath							= "User Preset Path";
		public string examplePresetPath							= "Example Preset Path";
		...
		public string noUserPresetsFound						= "No user presets found in any \"Resources/Presets\" folder. Press \"Create\" to make a new preset.";
		public string noExamplePresetsFound						= "No example presets found. Make sure they are stored in"; // Folder path always added last
